...
- Name: ui\component-ui.spec.ts >> Component UI Validation >> Flourish Story UI Testing
- Location: tests\ui\component-ui.spec.ts:146:5
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 1005px, received 375px by 1004px. 

  Snapshot: Flourish Story\flourish-story-page-expected.png

Call log:
  - Expect "toHaveScreenshot(Flourish Story\\flourish-story-page-expected.png)" with timeout 15000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e5]:
    - generic [ref=e11]:
      ...
      - separator [ref=e17]
      - generic [ref=e21]: Flourish Story (Stub)
    - separator [ref=e24]
    - separator [ref=e27]
```
