...
- Name: ui\component-ui.spec.ts >> Component UI Validation >> EGR Widget Component UI Testing
- Location: tests\ui\component-ui.spec.ts:248:5
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 1137px, received 375px by 1136px. 

  Snapshot: EGR Widget Component\egr-widget-component-page-expected.png

Call log:
  - Expect "toHaveScreenshot(EGR Widget Component\\egr-widget-component-page-expected.png)" with timeout 15000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e5]:
    - generic [ref=e8]:
      - heading "EGR Widget Component" [level=1] [ref=e11]
      - generic [ref=e13]:
        - heading "Latest Expected growth rate" [level=3] [ref=e14]
        - paragraph [ref=e15]: The figures above show the current Expected Growth Rates, gross of all product charges (including Annual Management Charges) unless indicated otherwise.
      - generic [ref=e19]:
        ...
        - generic [ref=e21]:
          - generic [ref=e23]:
            - generic [ref=e24]:
              - generic [ref=e25]:
                - heading "Latest Expected growth rate" [level=3] [ref=e26]
                - button "EGR Tooltip" [ref=e29] [cursor=pointer]
              - paragraph [ref=e31]: Select a Product and then a Fund to see today’s Expected Growth Rate
            - generic [ref=e32]:
              - generic [ref=e33]:
                - generic [ref=e34]: Product Type
                - generic [ref=e35]:
                  - combobox [ref=e38]
                  - button "Flexible Retirement Plan" [ref=e40] [cursor=pointer]:
                    - generic [ref=e42]: Flexible Retirement Plan
                    - img [ref=e44]
              - generic [ref=e46]:
                - generic [ref=e47]: Fund Type
                - generic [ref=e48]:
                  - combobox [ref=e51]
                  - button "PruFund Cautious Pension Fund/PruFund Protected Cautious Pension Fund" [ref=e53] [cursor=pointer]:
                    - generic [ref=e55]: PruFund Cautious Pension Fund/PruFund Protected Cautious Pension Fund
                    - img [ref=e57]
          - generic [ref=e60]:
            - heading "6.70%" [level=1] [ref=e61]
            - paragraph [ref=e64]: The figures above show the current Expected Growth Rates, gross of all product charges (including Annual Management Charges) unless indicated otherwise.
            - link "View EGR" [ref=e67] [cursor=pointer]:
              - /url: https://showcase-www-stage.mandg.com/adviser/core-components/supporting-pages/InternalLinkChecker
              - generic [ref=e69]: View EGR
    - separator [ref=e72]
    - separator [ref=e75]
```
