...
- Name: ui\component-ui.spec.ts >> Component UI Validation >> Download Button UI Testing
- Location: tests\ui\component-ui.spec.ts:476:5
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 375px by 727px, received 375px by 726px. 

  Snapshot: Download Button\download-button-page-expected.png

Call log:
  - Expect "toHaveScreenshot(Download Button\\download-button-page-expected.png)" with timeout 15000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e5]:
    - generic [ref=e8]:
      - generic [ref=e10]:
        - heading "Download Button" [level=1] [ref=e11]
        - heading "What does combining pensions mean?" [level=4] [ref=e12]
        - list [ref=e13]:
          - listitem [ref=e14]: Throughout your working life, there’s a good chance you’ll have built up several pensions. It’s surprisingly common, and surprisingly easy to lose track of them.
          - listitem [ref=e15]: Combining pensions (sometimes referred to as pension consolidation) simply means taking your different pensions and merging them into one plan. All your money will be in the same place, which could make retirement planning much simpler.
          - listitem [ref=e16]: Sometimes in life, less is more. And when it comes to pensions, having a single plan instead of a few can make the world of difference.
      - link "Download PDF" [ref=e18] [cursor=pointer]:
        - /url: /content/dam/mandg/qa/images/download-print/M-and-G.pptx
        - generic [ref=e20]: Download PDF
      - link "Download Doc" [ref=e22] [cursor=pointer]:
        - /url: /content/dam/mandg/qa/images/download-print/Print-Download-Button.docx
        - generic [ref=e24]: Download Doc
    - separator [ref=e27]
    - separator [ref=e30]
```
