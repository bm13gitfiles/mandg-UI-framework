...
- Name: ui\component-ui.spec.ts >> Component UI Validation >> Right Hand Sticky Variant2 UI Testing
- Location: tests\ui\component-ui.spec.ts:632:5
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 960px by 2139px, received 960px by 2138px. 

  Snapshot: Right Hand Sticky Variant2\right-hand-sticky-variant2-page-expected.png

Call log:
  - Expect "toHaveScreenshot(Right Hand Sticky Variant2\\right-hand-sticky-variant2-page-expected.png)" with timeout 15000ms
  ...
  - generic [ref=e5]:
    - navigation "Breadcrumb" [ref=e7]:
      - list [ref=e8]:
        ...
        - listitem [ref=e24]:
          - generic [ref=e25]: Right Hand Sticky Varient2
    - generic [ref=e27]:
      - heading "Right Hand Sticky Varient2" [level=2] [ref=e29]
      - img "test" [ref=e31]
    - generic [ref=e38]:
      - generic [ref=e44]:
        ...
        - paragraph [ref=e54]: 5 min read
      - generic [ref=e60]:
        - heading "Key Themes" [level=4] [ref=e63]
        - separator [ref=e66]
        - generic [ref=e68]:
          - heading [level=4]
          - list [ref=e69]:
