...
- Name: ui\component-ui.spec.ts >> Component UI Validation >> One Trust Cookie Embed UI Testing
- Location: tests\ui\component-ui.spec.ts:775:5
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 960px by 5489px, received 960px by 600px. 160138 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: One Trust Cookie Embed\one-trust-cookie-embed-page-expected.png

Call log:
  - Expect "toHaveScreenshot(One Trust Cookie Embed\\one-trust-cookie-embed-page-expected.png)" with timeout 15000ms
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e5]:
    - generic [ref=e11]:
      - separator [ref=e14]
      - button "Cookie settings" [ref=e17] [cursor=pointer]
    - separator [ref=e21]
    - separator [ref=e24]
```
